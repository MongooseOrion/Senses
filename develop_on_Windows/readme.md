...
## 本页内容
  ...
  * [使用 WSL 部署 Vitis-AI 主机开发环境](https://github.com/MongooseOrion/Senses/blob/main/develop_on_Windows/wsl_vitis_ai.md)
  * [使用 Ubuntu 部署 Vitis-AI 主机开发环境](https://github.com/MongooseOrion/Senses/blob/main/develop_on_Windows/ubuntu_vitis_ai.md)

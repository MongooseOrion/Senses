...
由图中可以得到，式3.2.1 将变为
$$v_1(s)=\frac{\frac{v_i(s)}{r_s}-i_2(s)}{sc_1+\frac{1}{r_s}} \tag{3.2.2}$$

同时 $i_1(s)$ 列写为：
$$i_1(s)=\frac{v_i(s)}{r_s}-i_s(s)-i_2(s)=\frac{v_i(s)}{r_s}-\frac{v_1(s)}{r_s}-i_2(s) \tag{3.2.3}$$

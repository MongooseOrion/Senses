# 深度学习实例
人工智能这个词不算陌生，不过在此之前，总还是在新闻和学术报告听到的、浅尝辄止的概念，没有了解过构成，也没了解过如何实现。这当然与我从来没有接触过 Python 有关。而现在，在对 Python 有一个基础认识后，终于可以正式踏入深度学习领域了。在此处将包含我总结的一些**人工智能概念**和**热门人工智能算法仓库**。
